package VMOMI::ServiceInstanceOps;
use parent 'VMOMI::ServiceInstanceSoap';
...
sub HasPrivilegeOnEntity {
    ...
    return $self->soap_call('HasPrivilegeOnEntity', undef, 1, $x_args, \%args);
}
...
sub DoesCustomizationSpecExist {
    ...
    return $self->soap_call('DoesCustomizationSpecExist', undef, 0, $x_args, \%args);
}
...
sub CheckLicenseFeature {
    ...
    return $self->soap_call('CheckLicenseFeature', undef, 0, $x_args, \%args);
}
...
sub EnableFeature {
    ...
    return $self->soap_call('EnableFeature', undef, 0, $x_args, \%args);
}
...
sub DisableFeature {
    ...
    return $self->soap_call('DisableFeature', undef, 0, $x_args, \%args);
}
...
sub SessionIsActive {
    ...
    return $self->soap_call('SessionIsActive', undef, 0, $x_args, \%args);
}
...
sub CreateVRP {
    ...
    return $self->soap_call('CreateVRP', undef, 0, $x_args, \%args);
}
...
sub UpdateVRP {
    ...
    return $self->soap_call('UpdateVRP', undef, 0, $x_args, \%args);
}
...
sub DeleteVRP {
    ...
    return $self->soap_call('DeleteVRP', undef, 0, $x_args, \%args);
}
...
sub DeployVM {
    ...
    return $self->soap_call('DeployVM', undef, 0, $x_args, \%args);
}
...
sub UndeployVM {
    ...
    return $self->soap_call('UndeployVM', undef, 0, $x_args, \%args);
}
...
sub SetManagedByVDC {
    ...
    return $self->soap_call('SetManagedByVDC', undef, 0, $x_args, \%args);
}
...
sub GetAllVRPIds {
    ...
    return $self->soap_call('GetAllVRPIds', undef, 1, $x_args, \%args);
}
...
sub GetRPSettings {
    ...
    return $self->soap_call('GetRPSettings', 'ResourceConfigSpec', 0, $x_args, \%args);
}
...
sub GetVRPSettings {
    ...
    return $self->soap_call('GetVRPSettings', 'VirtualResourcePoolSpec', 0, $x_args, \%args);
}
...
sub GetVRPUsage {
    ...
    return $self->soap_call('GetVRPUsage', 'VirtualResourcePoolUsage', 0, $x_args, \%args);
}
...
sub GetVRPofVM {
    ...
    return $self->soap_call('GetVRPofVM', undef, 0, $x_args, \%args);
}

sub GetChildRPforHub {
    my ($self, %args) = @_;
    my $x_args = [ 
      ['_this', 'ManagedObjectReference'],
      ['vrpId', undef],
    ...
    return $self->soap_call('GetChildRPforHub', 'ManagedObjectReference', 0, $x_args, \%args);
}
...
sub PerformVsanUpgrade_Task {
    ...
    my $x_args = [ 
      ['_this', 'ManagedObjectReference'],
      ['cluster', 'ManagedObjectReference'],
      ['performObjectUpgrade', undef],
      ['downgradeFormat', undef],
      ['allowReducedRedundancy', undef],
...
sub AreAlarmActionsEnabled {
    ...
    return $self->soap_call('AreAlarmActionsEnabled', undef, 0, $x_args, \%args);
}
...
sub GenerateCertificateSigningRequest {
    ...
    my $x_args = [ 
      ['_this', 'ManagedObjectReference'],
      ['useIpAddressAsCommonName', undef],
    ];
...
sub QueryVmfsDatastoreExtendOptions {
    ...
    my $x_args = [ 
      ...
      ['datastore', 'ManagedObjectReference'],
      ['devicePath', undef],
      ['suppressExpandCandidates', undef],
    ];
...
sub IsSharedGraphicsActive {
    ...
    return $self->soap_call('IsSharedGraphicsActive', undef, 0, $x_args, \%args);
}
